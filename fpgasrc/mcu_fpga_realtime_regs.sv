...
module mcu_fpga_realtime_regs (
    ...
    always_comb begin
        ...
        decoded_reg_strb.interface_regs.reset_vector = cpuif_req_masked & (cpuif_addr == 13'h38);
        decoded_reg_strb.interface_regs.nmi_vector = cpuif_req_masked & (cpuif_addr == 13'h3c);
    ...
    for(genvar i0=0; i0<2; i0++) begin
        // Field: mcu_fpga_realtime_regs.interface_regs.generic_input_wires[].value
        always_comb begin
    ...
    for(genvar i0=0; i0<2; i0++) begin
        // Field: mcu_fpga_realtime_regs.interface_regs.generic_output_wires[].value
        always_comb begin
    ...
    always_comb begin
        automatic logic [0:0] next_c = field_storage.interface_regs.control.rst_l.value;
        automatic logic load_next_c = '0;
    ...
    always_comb begin
        automatic logic [0:0] next_c = field_storage.interface_regs.control.dbg_rst_l.value;
        automatic logic load_next_c = '0;
        if(decoded_reg_strb.interface_regs.control && decoded_req_is_wr) begin // SW write
    ...
    // Field: mcu_fpga_realtime_regs.interface_regs.control.ss_debug_locked
    always_comb begin
    ...
    // Field: mcu_fpga_realtime_regs.interface_regs.control.ss_device_lifecycle
    always_comb begin
    ...
    // Field: mcu_fpga_realtime_regs.interface_regs.control.bootfsm_brkpoint
    always_comb begin
    ...
    // Field: mcu_fpga_realtime_regs.interface_regs.reset_vector.reset_vector
    always_comb begin
        automatic logic [31:0] next_c = field_storage.interface_regs.reset_vector.reset_vector.value;
        automatic logic load_next_c = '0;
        if(decoded_reg_strb.interface_regs.reset_vector && decoded_req_is_wr) begin // SW write
            next_c = (field_storage.interface_regs.reset_vector.reset_vector.value & ~decoded_wr_biten[31:0]) | (decoded_wr_data[31:0] & decoded_wr_biten[31:0]);
            load_next_c = '1;
        end
        field_combo.interface_regs.reset_vector.reset_vector.next = next_c;
        field_combo.interface_regs.reset_vector.reset_vector.load_next = load_next_c;
    end
    always_ff @(posedge clk) begin
        if(rst) begin
            field_storage.interface_regs.reset_vector.reset_vector.value <= 32'h0;
        end else if(field_combo.interface_regs.reset_vector.reset_vector.load_next) begin
            field_storage.interface_regs.reset_vector.reset_vector.value <= field_combo.interface_regs.reset_vector.reset_vector.next;
        end
    end
    assign hwif_out.interface_regs.reset_vector.reset_vector.value = field_storage.interface_regs.reset_vector.reset_vector.value;
    // Field: mcu_fpga_realtime_regs.interface_regs.nmi_vector.nmi_vector
    always_comb begin
        automatic logic [31:0] next_c = field_storage.interface_regs.nmi_vector.nmi_vector.value;
        automatic logic load_next_c = '0;
        if(decoded_reg_strb.interface_regs.nmi_vector && decoded_req_is_wr) begin // SW write
            next_c = (field_storage.interface_regs.nmi_vector.nmi_vector.value & ~decoded_wr_biten[31:0]) | (decoded_wr_data[31:0] & decoded_wr_biten[31:0]);
            load_next_c = '1;
        end
        field_combo.interface_regs.nmi_vector.nmi_vector.next = next_c;
        field_combo.interface_regs.nmi_vector.nmi_vector.load_next = load_next_c;
    end
    always_ff @(posedge clk) begin
        if(rst) begin
            field_storage.interface_regs.nmi_vector.nmi_vector.value <= 32'h0;
        end else if(field_combo.interface_regs.nmi_vector.nmi_vector.load_next) begin
            field_storage.interface_regs.nmi_vector.nmi_vector.value <= field_combo.interface_regs.nmi_vector.nmi_vector.next;
        end
    end
    assign hwif_out.interface_regs.nmi_vector.nmi_vector.value = field_storage.interface_regs.nmi_vector.nmi_vector.value;
    ...
    always_comb begin
        automatic logic [7:0] next_c = field_storage.fifo_regs.log_fifo_input.char.value;
        automatic logic load_next_c = '0;
    ...
    assign readback_array[12][0:0] = (decoded_reg_strb.interface_regs.control && !decoded_req_is_wr) ? field_storage.interface_regs.control.rst_l.value : '0;
    assign readback_array[12][1:1] = (decoded_reg_strb.interface_regs.control && !decoded_req_is_wr) ? field_storage.interface_regs.control.dbg_rst_l.value : '0;
    ...
    assign readback_array[14][31:0] = (decoded_reg_strb.interface_regs.reset_vector && !decoded_req_is_wr) ? field_storage.interface_regs.reset_vector.reset_vector.value : '0;
    assign readback_array[15][31:0] = (decoded_reg_strb.interface_regs.nmi_vector && !decoded_req_is_wr) ? field_storage.interface_regs.nmi_vector.nmi_vector.value : '0;
    assign readback_array[16][7:0] = (decoded_reg_strb.fifo_regs.log_fifo_data && !decoded_req_is_wr) ? field_storage.fifo_regs.log_fifo_data.next_char.value : '0;
    assign readback_array[16][8:8] = (decoded_reg_strb.fifo_regs.log_fifo_data && !decoded_req_is_wr) ? field_storage.fifo_regs.log_fifo_data.char_valid.value : '0;
    assign readback_array[16][31:9] = '0;
    assign readback_array[17][0:0] = (decoded_reg_strb.fifo_regs.log_fifo_status && !decoded_req_is_wr) ? field_storage.fifo_regs.log_fifo_status.log_fifo_empty.value : '0;
    assign readback_array[17][1:1] = (decoded_reg_strb.fifo_regs.log_fifo_status && !decoded_req_is_wr) ? field_storage.fifo_regs.log_fifo_status.log_fifo_full.value : '0;
    assign readback_array[17][31:2] = '0;
    assign readback_array[18][7:0] = (decoded_reg_strb.fifo_regs.log_fifo_input && !decoded_req_is_wr) ? field_storage.fifo_regs.log_fifo_input.char.value : '0;
    assign readback_array[18][31:8] = '0;
